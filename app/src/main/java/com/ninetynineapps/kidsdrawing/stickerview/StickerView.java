package com.ninetynineapps.kidsdrawing.stickerview;
...
public abstract class StickerView extends FrameLayout {
    ...
    public static int SELF_SIZE_DP = 100;
    //public static int SELF_SIZE_WIDTH = 100;
    //public static int SELF_SIZE_HEIGHT = 100;
    StickerCallback stickerCallback;

    public StickerView(Context context, StickerCallback stickerCallback) {
        super(context);
    ...
    private void init(Context context) {
        ...
        //int width = convertDpToPixel(SELF_SIZE_WIDTH, getContext());
        //int height = convertDpToPixel(SELF_SIZE_HEIGHT, getContext());

        LayoutParams this_params;
        if (SELF_SIZE_DP > 150) {
            this_params = new LayoutParams(size, size + 150);
        } else {
            this_params = new LayoutParams(size, size);
        }

        //this_params = new FrameLayout.LayoutParams(size, size);
        ...
        this.iv_delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (StickerView.this.getParent() != null) {
                    stickerCallback.onDeleteSticker();
    ...
    private OnTouchListener mTouchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            if (view.getTag().equals("DraggableViewGroup")) switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    try {
                       StickerConstant.ivSticker = (StickerImageView) view;
                       StickerConstant.ivSticker.setControlItemsHidden(false);
                    } catch (Exception e) {
                       e.printStackTrace();
                    }
